    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="p-5 mb-4 mt-4 bg-light rounded-3 border border-dark">
                ...
                <hr class="my-4">
                <table class="table table-bordered table-striped table-hover text-center" id="table2">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-sm-4"><a class="btn btn-primary btn-lg border border-dark" href="../index.php" role="button">Regresar a la seleccion</a></div>
                    <div class="col-sm-4"></div>
                </div>
            </div>
        </div>
